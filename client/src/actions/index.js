import {
  ...
  SIGN_UP_OK, SIGN_UP_FAILURE, STATISTICS_COURSES, STATISTICS_LOADING_COURSES,
  STATISTICS_LOADING_MEASUREMENTS, STATISTICS_MEASUREMENTS_BAD, STATISTICS_MEASUREMENTS,
  LOGOUT,
...
export function statisticsMeasurementsBad(measurements) {
  return {
    type: STATISTICS_MEASUREMENTS_BAD,
    payload: measurements,
  };
}
